...
const AddUserModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  // Update the handleSubmit function to send the correct data format to the backend
  const handleSubmit = async (e) => {
    ...
    try {
      // Create a new object with the backend's expected format
      const userData = {
        name: formData.name,
        email: formData.email,
        password: formData.password,
        roles: formData.roles // Use the array of roles
      };
